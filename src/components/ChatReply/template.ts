...
<section class="{{styles.b-chat-reply-wrapper}}">
    <form class="{{styles.b-chat-reply}}" action="/">
        <figure class="{{styles.b-attach-file}}">
            <a class='{{styles.b-attach-file-link}}'>
    ...
    <div class="{{styles.b-chat-reply-attachment-wrapper}}">
        <div class="{{styles.b-chat-reply-attachment}}">
            <a class="{{styles.b-link}}">
